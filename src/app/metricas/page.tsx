...
export default function MetricasPage() {
  ...
  async function handleSalvar() {
    if (!motoristaId || !data || !total) {
      alert("Preencha motorista, data e total de pacotes");
      return;
    }
        ...
        <main className="p-6 bg-zinc-950 min-h-screen">
          ...
          <div className="bg-zinc-900 p-6 rounded space-y-4 mb-8">
            ...
            <div className="bg-black p-4 rounded">
              <p className="text-white">DS Calculado</p>
                ...
                >
                  <div>
                    ...
                    <p className="text-zinc-500 text-sm">
                      Motivo: {metrica.motivoNaoEntrega || "-"}
                    </p>
                  </div>
